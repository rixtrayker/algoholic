...
export default function PracticePage() {
  ...
  const submitMutation = useMutation({
    ...
    onError: (error: unknown) => {
      ...
      toast.error(err.response?.data?.error || 'Failed to submit answer. Please try again.');
    },
  });
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="card">
        <div className="mb-4">
          ...
          <h2 className="text-xl font-semibold text-gray-900 mb-2">{question.question_text}</h2>
          ...
          <p className="text-xs text-gray-600">Difficulty: {question.difficulty_score?.toFixed(0)}/100</p>
        </div>
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <span className="text-gray-700">
                        {typeof option === 'string' ? option : (option as { text?: string })?.text || JSON.stringify(option)}
                      </span>
                    </div>
                  </label>
                ))}
          ...
          <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className={`text-sm ${result.is_correct ? 'text-green-700' : 'text-red-700'}`}>
                    {result.is_correct
                      ...
                      : `The correct answer was: ${JSON.stringify(result.correct_answer)}`}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 pt-2">
              ...
              <div className="p-3 bg-gray-50 rounded-lg">
                ...
                <p className="text-lg font-semibold text-primary-600">+{result.points_earned || 0}</p>
              </div>
            </div>
